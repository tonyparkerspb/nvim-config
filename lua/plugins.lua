...
packer.startup({
	function(use)
		...
		use({ "tonyparkerspb/nvim-cmp", after = "lspkind.nvim", config = [[require('config.nvim-cmp')]] })
		...
		use({ "tonyparkerspb/nvim-lspconfig", after = "mason-lspconfig.nvim", config = [[require('config.lsp')]] })
		...
		-- fancy start screen
		use({ "tonyparkerspb/dashboard-nvim", event = "VimEnter", config = [[require('config.dashboard-nvim')]] })
		...
		use({ "tonyparkerspb/zen-mode.nvim", cmd = "ZenMode", config = [[require('config.zen-mode')]] })
		...
		use({
			...
			branch = "v2.x",
			requires = {
				"tonyparkerspb/plenary.nvim",
				"tonyparkerspb/nvim-web-devicons", -- not strictly required, but recommended
		...
		use({ "tonyparkerspb/fidget.nvim", after = "nvim-lspconfig", config = [[require('config.fidget-nvim')]] })
